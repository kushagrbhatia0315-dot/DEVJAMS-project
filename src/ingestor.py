...
def extract_storms(storms_dir: str, features: list) -> pd.DataFrame:
    """Extracts and combines all Storm CSVs from the data folder."""
    ...
    # Grab a list of every CSV file inside the folder
    ...
    # Read each file and stitch them vertically into one massive DataFrame
    df_list = []
